  ...
  return (
    <div className={styles.calculator}>
      ...
      <div className={styles.keyboard}>
        ...
        <button type="button" className={classnames(styles.button, styles.buttonUtil)} onClick={negate}>+/-</button>
        <button type="button" className={classnames(styles.button, styles.buttonUtil)} onClick={percent}>%</button>
        <button
          type="button"
          className={
          classnames(
            ...
            { [styles.buttonOperatorHighlighted]: highlightedOperator === Operator.DIVIDE },
          )
}
        ...
        <button
          ...
          classnames(
            styles.button,
            styles.buttonOperator,
            { [styles.buttonOperatorHighlighted]: highlightedOperator === Operator.MULTIPLY },
          )
}
        ...
        <button
          ...
          classnames(
            styles.button,
            styles.buttonOperator,
            { [styles.buttonOperatorHighlighted]: highlightedOperator === Operator.SUBTRACT },
          )
}
        ...
        <button
          ...
          classnames(
            styles.button,
            styles.buttonOperator,
            { [styles.buttonOperatorHighlighted]: highlightedOperator === Operator.ADD },
          )
}
        ...
        <button type="button" className={classnames(styles.button, styles.buttonWide)} onClick={() => input(0)}>
          0
        </button>
        <button type="button" className={classnames(styles.button)} onClick={decimal}>,</button>
        <button type="button" className={classnames(styles.button, styles.buttonOperator)} onClick={calculate}>
          =
        </button>
      </div>
    </div>
